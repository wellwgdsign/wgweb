...
function showPixManual(orderData) {
    ...
    '<div class="modal-content">'+
        ...
        '<div class="pix-container">'+
            '<img src="https://i.imgur.com/Y2rsllJ.jpeg" alt="QR Code Pix" class="qrcode-img">'+
            '<p style="font-size: 15px;">Escaneie o QR Code ou copie o código abaixo:</p>'+
            '<textarea id="pixCopiaECola" readonly>00020101021126790014BR.GOV.BCB.PIX2557pix-qr.mercadopago.com/instore/ol/v2/rYdwb2MoxUxyeF9aURTH5204000053039865802BR5905WHELL6009SAO PAULO62080504mpis63047916</textarea>'+
            '<button onclick="copiarPix()" class="btn-copiar">Copiar Pix</button>'+
        '</div>'+
    '</div>' +
                '<a href="' + whatsappUrl + '" target="_blank" class="pm-whatsapp-btn">' +
                    '<i class="ri-whatsapp-line"></i> Enviar Comprovante' +
                '</a>' +
                '<div class="pm-steps">' +
                    '<h4>Como funciona:</h4>' +
                    '<div class="pm-step"><span class="pm-step-num">1</span><span>Escaneie  o QrCode Pix</span></div>' +
                    '<div class="pm-step"><span class="pm-step-num">2</span><span>Digite o valor do Produto a ser Adiquirido</span></div>' +
                    '<div class="pm-step"><span class="pm-step-num">3</span><span>Finalize o Pagamento via Mercado Pago</span></div>' +
...
function injectPaymentStyles() {
    ...
    style.textContent = [
        ...
        '.pm-content { position: relative; background: #1a1a2e; border: 1px solid rgba(255,255,255,0.08); border-radius: 16px; width: 100%; max-width: 440px; max-height: 90vh; overflow-y: auto; box-shadow: 0 20px 60px #00bcd426; }',
        ...
        '.pm-value { text-align: center; padding: 10px; background: rgba(200,255,0,0.04); border: 1px solid rgba(200,255,0,0.1); border-radius: 10px; margin-bottom: 5px; }',
        '.pm-value span { display: block; font-size: 0.78rem; color: #fff; margin-bottom: 0px; }',
        '.pm-value strong { font-size: 1.5rem; color: #16e5ff; }',
        ...
        '.pm-steps h4 { font-size: 0.82rem; color: #eee; margin-bottom: 5px; text-align: center; }',
        '.pm-step { display: flex; align-items: center; gap: 10px; padding: 8px 0; font-size: 0.8rem; color: rgba(255, 255, 255, 0.71); }',
        '.pm-step-num { width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; background: #00d4aa; color: #000; border-radius: 50%; font-size: 0.7rem; font-weight: 700; flex-shrink: 0; }',
        ...
        '.pm-whatsapp-btn { display: flex; align-items: center; justify-content: center; gap: 10px; margin-left: 25%; width: 50%; padding: 10px 10px; background: #25D366; color: #fff; border: none; border-radius: 10px; font-size: 0.95rem; font-weight: 600; text-decoration: none; cursor: pointer; transition: all 0.2s; }',
